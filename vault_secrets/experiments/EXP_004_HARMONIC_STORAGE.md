# 🔬 REPORTE EXPERIMENTAL: EXP-004 ALMACENAMIENTO ARMÓNICO DE ALTA DENSIDAD EN CRISTALES S60 (SIMULACIÓN DE SUPERCONDUCTIVIDAD)
...
$$ I = f(A*{S60}) \bigg|*{cond} \quad \text{con} \quad \frac{dI}{dt} = 0 \iff \gamma = 0 $$
...
$$ E*{total} = \sum*{n=0}^{\infty} \hbar \omega (n + 1/2) $$
