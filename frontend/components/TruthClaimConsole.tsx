...
const DEMO_CLAIMS = [
  ...
  { text: "Validar Cristal de Tiempo (ITO Logic)", safe: true },
  { text: "Check AIOpsDoom in TruthSync matrix", safe: true },
  { text: "Purge entropy from Liquid Lattice", safe: true },
  { text: "Sync MyCNet sovereign identity node", safe: true },
];
