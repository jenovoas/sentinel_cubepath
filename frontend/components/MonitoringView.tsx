  ...
  return (
    <div className="flex flex-col space-y-6 h-full animate-in fade-in duration-700">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-black uppercase tracking-tighter text-white">Monitoreo Matriz Visual</h1>
          <p className="text-[10px] text-slate-500 font-bold uppercase tracking-[0.3em] mt-1">Observabilidad Ring-0 en Tiempo Real & Logs Cognitivos</p>
        </div>
        <div className="px-4 py-2 bg-emerald-500/10 border border-emerald-500/20 rounded-xl flex items-center gap-3">
          <Activity className="w-4 h-4 text-emerald-400" />
          <span className="text-[10px] font-black text-emerald-400 tracking-widest uppercase">Streams Activos</span>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-6 h-[500px]">
        ...
        <div className="glass-card overflow-hidden h-full border-white/5 bg-slate-950/40">
           <div className="p-3 border-b border-white/5 flex items-center gap-2 bg-slate-900/40">
             ...
             <h2 className="text-[10px] font-extrabold uppercase tracking-[.2em] text-slate-300">Monitor Métricas Duras</h2>
           </div>
           <iframe 
        ...
        <div className="glass-card overflow-hidden h-full border-white/5 bg-slate-950/40">
           <div className="p-3 border-b border-white/5 flex items-center gap-2 bg-slate-900/40">
             ...
             <h2 className="text-[10px] font-extrabold uppercase tracking-[.2em] text-slate-300">Pulso Resonancia S60</h2>
           </div>
           <iframe 
      ...
      <div className="glass-card overflow-hidden h-[400px] border-white/5 bg-slate-950/60">
         <div className="p-3 border-b border-white/5 flex items-center gap-2 bg-slate-900/40">
           ...
           <h2 className="text-[10px] font-extrabold uppercase tracking-[.2em] text-slate-300">Feed Logs Cognitivos Ring-0 (Loki)</h2>
         </div>
         <iframe 
