...
$$ I\_{max} \le \frac{2\pi R E}{\hbar c \ln 2} $$
...
- **Holografía:** La información se codifica en la _relación_ de fase entre cristales, no solo en su magnitud individual. El límite por cristal define el "pixel" de la red holográfica.
